            ...
            <div class="container py-md-5">
                ...
                <div class="row">
                    ...
                    <div class="col-12 text-center pt-md-4">
                        <ul class="list-group lit-unstyled list-group-horizontal justify-content-center gap-2">
                            <li class="list-group-item product_gallery_btn_div disabled"><a href="" class="product_gallery_btn"><</a></li>
                            <li class="list-group-item product_gallery_btn_div active"><a href="" class="product_gallery_btn">1</a></li>
                            <li class="list-group-item product_gallery_btn_div"><a href="" class="product_gallery_btn">2</a></li>
                            <li class="list-group-item product_gallery_btn_div"><a href="" class="product_gallery_btn">3</a></li>
                            <li class="list-group-item product_gallery_btn_div"><a href="" class="product_gallery_btn">></a></li>
                        </ul>
                    </div>                    
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-md-3 sidebar ps-0">
                        ...
                        <ul class="list-group filter_list">
                            <li class="list-group-item active">Phosphate Esters</li>
                            <li class="list-group-item">Surfactant & Antistatic...</li>
                            <li class="list-group-item">Hydrobromic Acid</li>
                            <li class="list-group-item">Plasticizers</li>
                            <li class="list-group-item">Anti-hydrolysis Agent</li>
                            <li class="list-group-item">Polyurethane & Cast...</li>
                            <li class="list-group-item">Green Chemistry</li>
                            <li class="list-group-item">C5 Products</li>
                            <li class="list-group-item">Glycolic Acid</li>
                            <li class="list-group-item">Persulphates</li>
                            <li class="list-group-item">Nitrates & Metabisulfites</li>
                            <li class="list-group-item">Refined Glycerine</li>
                            <li class="list-group-item">Triazoles</li>
                            <li class="list-group-item">Amines</li>
                            <li class="list-group-item">Dibenzoates</li>
                            <li class="list-group-item">Initiators</li>
                            <li class="list-group-item">Phosphonic and...</li>
                            <li class="list-group-item">Inorganic Phosphite...</li>
                            <li class="list-group-item">Diphenols</li>
                            <li class="list-group-item">Fluorine Derivatives</li>
                            <li class="list-group-item">Other Products</li>
                            <li class="list-group-item">Solvents</li>
                            <li class="list-group-item">Polymers</li>
                    ...
                    <div class="col-md-9 product_filter_gallery">
                        ...
                        <div class="col-3 text-center pt-md-4 float-end">
                            <ul class="list-group lit-unstyled list-group-horizontal justify-content-center gap-2">
                                <li class="list-group-item product_gallery_btn_div disabled"><a href="" class="product_gallery_btn"><</a></li>
                                <li class="list-group-item product_gallery_btn_div active"><a href="" class="product_gallery_btn">1</a></li>
                                <li class="list-group-item product_gallery_btn_div"><a href="" class="product_gallery_btn">2</a></li>
