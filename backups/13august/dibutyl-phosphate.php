        ...
        <section class="banner" id="product_categories_banner_img">
            <div class="container ">
                <div class="banner_heading_div text-center">
                    <h2 class="text-light banner_heading_text">Dibutyl Phosphate</h2>
                    <ul class="list-group list-unstyled list-group-horizontal banner_heading_breadcrumb">
                        ...
                        <li class="list-group-item"><p class="mb-0">Dibutyl Phosphate</p></li>
                    </ul>
                </div>                
            </div>
        </section>
            ...
            <div class="container product-section py-md-5">
                <div class="row">
                    <div class="col-md-5 text-center product_img_div">
                        <img class="img-fluid product_img" src="images/product-categories/dibutyl_phosphate.png" alt="Chemical Structure">
                    </div>
                    <div class="col-md-7 ps-md-5 product_details">
                        <div class="product_heading_btn_next_prev_div">
                            <h2 class="product_heading text-start pb-md-1"><span class="our">Dibutyl Phsophate</span></h2>
