...
<body style="background-color: #333;">
    <header id="mainHeader" class="header transparent">
        <div class="container">
            <div class="d-flex flex-column">
                <div class="top_bar col-12 py-md-3 pt-2">                
    ...
    <main class="home-page">
        ...
        <section class="white_section our_products" id="our_products">
            <div class="container pt-md-5 pt-3 pb-md-2">
                <h2 class="product_heading text-center pb-md-1"><span class="our">OUR</span> PRODUCT</h2>
                <div class="row">
                    <div class="col-md-3 col-12 our_product_cards_div">
                        <a href="dibutyl-phosphate.php" class="d-flex align-items-center justify-content-between text-decoration-none w-100">
                            <div class="card">
                                ...
                                <div class="card-body d-flex">
                                    <p class="card-text">Phosphate Esters & <br> Flame  Retardant</p>
                    ...
                    <div class="col-md-3 col-12 our_product_cards_div">
                        <a href="dibutyl-phosphate.php" class="d-flex align-items-center justify-content-between text-decoration-none w-100">
                            <div class="card">
                                ...
                                <div class="card-body d-flex">
                                    <p class="card-text">Polyurethane & Cast <br> Nylon Additives</p>
                                    <i class="btn btn-primary fa fa-arrow-right"></i>
                                </div>
                            </div>
                        </a>
                    ...
                    <div class="col-12 text-center pt-md-4 pt-2">
                ...
                <div class="row">
                    <div class="col-md-11 background_blue_img p-md-5">
                        <div class="col-md-8">
                            ...
                            <a href="about-us.php" class="btn a_btn white_btn btn-lg mt-3">Read More <i class="fa fa-arrow-right"></i></a>                    
                        </div>
                    </div>
        ...
        <section class="white_section industry_we_cater">
            <div class="container py-md-5">
                ...
                <div class="row industry_contents_main_div">
                    ...
                    <div class="col-md-4 mb-0 pe-md-0">
                ...
                <div class="row justify-content-between position-relative">
                    ...
                    <div class="col-md-12 why_sscpl_bg_img position-absolute">
                        ...
                        <div class="row pt-md-5">
                            <div class="col-md-3 col-12 sscl_contents_main_div text-center pb-md-5">
