            ...
            <div class="container ">
                <div class="banner_heading_div text-center">
                    ...
                    <ul class="list-group list-unstyled list-group-horizontal banner_heading_breadcrumb">
                        ...
                        <li class="list-group-item"><p class="mb-0">What We Do</p></li>
                    </ul>
                </div>                
            </div>
        </section>
        ...
        <section class="white_section  partnership">
            <div class="container py-md-5">
                <div class="row">
                    ...
                    <div class="col-md-5">
                        <img class="right_img what_we_do_img ps-md-3" src="images/what-we-do/what_we_do_img.png">
                    </div>
                </div>
            </div>
        </section>
        ...
        <section class="blue_section  partnership">
            <div class="container py-md-5">
                <div class="d-flex flex-row-reverse">
                    ...
                    <div class="col-md-5">
                        <img class="right_img what_we_do_img pe-md-3" src="images/what-we-do/what_we_do_img.png">
                    </div>
                </div>
            </div>
